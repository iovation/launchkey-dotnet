...
namespace iovation.LaunchKey.Sdk.Tests.Integration.Features.Directory_Client.Services.Public_Keys
{
    ...
    [NUnit.Framework.DescriptionAttribute("Directory clients can remove Directory Service Public Keys")]
