...
namespace iovation.LaunchKey.Sdk.Tests.Integration.Features.Directory_Client.Totp
{
    ...
    [NUnit.Framework.DescriptionAttribute("Directory Client can generate TOTP for user")]
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/directory_client/totp", "Directory Client can generate TOTP for user", "  In order to manage User TOTP\n  As a Directory Client\n  I can request a shared s" +
...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("Creating TOTP returns the expected data")]
        public virtual void CreatingTOTPReturnsTheExpectedData()
        {
            string[] tagsOfScenario = ((string[])(null));
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Creating TOTP returns the expected data", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 9
