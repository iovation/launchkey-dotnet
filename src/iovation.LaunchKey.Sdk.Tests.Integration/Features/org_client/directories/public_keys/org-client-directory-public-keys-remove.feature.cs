...
namespace iovation.LaunchKey.Sdk.Tests.Integration.Features.Org_Client.Directories.Public_Keys
{
    ...
    [NUnit.Framework.DescriptionAttribute("Organization clients can remove Directory Public Keys")]
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/org_client/directories/public_keys", "Organization clients can remove Directory Public Keys", "  In order to manage the Public Keys in the Directory Public Key rotation\n  As an" +
...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Attempting to update an invalid Public Key for a Directory throws a Forbidden exc" +
            "eption")]
