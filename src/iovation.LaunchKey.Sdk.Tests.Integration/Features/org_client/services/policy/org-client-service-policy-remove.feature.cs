...
namespace iovation.LaunchKey.Sdk.Tests.Integration.Features.Org_Client.Services.Policy
{
    ...
    [NUnit.Framework.DescriptionAttribute("Organization Client can remove Organization Service Policy")]
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/org_client/services/policy", "Organization Client can remove Organization Service Policy", "  In order to manage the Authorization Policy of an Organization Service\n  As an " +
